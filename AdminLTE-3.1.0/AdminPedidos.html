                ...
                <div class="form-group row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <select id="inputState" class="form-control">
                      ...
                      <option>Corre retractil</option>
                    </select>
                </div>
                  <div class="col-4">
                    <label for="CorreoElectronico">Precio</label>
                    <input type="Numeber" class="form-control" id="apellidos" name="CorreoElectronico">
                  </div> 
            ...
            <table class="table table-striped table-dark">
              ...
              <tbody>
                <tr>
                  <th scope="row">1</th>
                  <td>Mark</td>
                  <td>Guacal Burbuaja</td>
                  <td>$ 100.000</td>
                  <td>1</td>
                  <td>Caller 46a #51-40</td>
                  <td>
